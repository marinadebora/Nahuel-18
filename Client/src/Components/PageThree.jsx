...
const PageThree = () =>
{
  return (
    <div className="w-full h-full lg:my-8 flex items-center justify-center italic ">
      <div className="w-[20rem] md:w-[40rem] lg:w-[60rem] p-8 flex flex-col gap-6 items-center justify-center bg-[#000] shadow-xl/30 shadow-[#c20000] text-white rounded-2xl">
      ...
      <img className='w-[15rem]' src={Image.salon} alt="logo del salon" />
      ...
      <div className='lg:w-[35rem] lg:h-[20rem] flex text-sm items-center justify-center'>
