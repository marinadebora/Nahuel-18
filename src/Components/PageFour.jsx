...
const PageFour = () => {
  return (
   <div className="w-full h-full mt-8 flex items-center justify-center italic">
      <div className="flex items-center justify-center rounded-2xl w-[21rem] md:w-[40rem] lg:w-[60rem] h-[20rem]  bg-[url(https://res.cloudinary.com/deqbqghhq/image/upload/v1753223898/fondoblanco_hqyv65.avif)] bg-cover  rounded-2xl ">
       <div className="w-[20rem] md:w-[39rem] lg:w-[59rem] h-[19rem] bg-black ">
       <div className='gap-2 flex flex-col h-full items-center justify-between text-[#fff] py-4 '>
          <div className='flex items-center justify-center'>
            <p className='text-xl lg:text-3xl text-center'>Tenes fotos en las que aparezcamos juntos?</p>
          </div>
